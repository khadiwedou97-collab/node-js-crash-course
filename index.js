...
mongoose.connect("mongodb+srv://khadi:khadi2026@cluster0.9qohym1.mongodb.net/?appName=Cluster0")
.then(()=>{
console.log("connected successfuly");
}).catch((error)=>{
    console.log("error with connecting with the DB", error);
})
//mongodb+srv://<db_username>:<db_password>@cluster0.9qohym1.mongodb.net/?appName=Cluster0
